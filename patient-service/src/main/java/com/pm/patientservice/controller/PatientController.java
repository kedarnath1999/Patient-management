...
public class PatientController {
    ...
    public ResponseEntity<PatientResponseDTO> createPatients(@Validated({Default.class,CreatePatientValidation.class}) @RequestBody PatientRequestDTO patientRequestDTO) {
